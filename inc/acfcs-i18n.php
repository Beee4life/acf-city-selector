<?php
    ...
    function acfcs_country_i18n( $country_code ) {
        ...
        $country_array = array(
            ...
            'ht'     => esc_html__( 'Haiti', 'acf-city-selector' ),
            'it'     => esc_html__( 'Italy', 'acf-city-selector' ),
            'jp'     => esc_html__( 'Japan', 'acf-city-selector' ),
            'lu'     => esc_html__( 'Luxembourg', 'acf-city-selector' ),
            'mx'     => esc_html__( 'Mexico', 'acf-city-selector' ),
            'noram'  => esc_html__( 'N-America', 'acf-city-selector' ),
