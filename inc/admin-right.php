<div class="admin_right">
    ...
    <p><?php echo sprintf( __( '<a href="%s" rel="noopener" target="_blank">Click here</a> for the official website.', 'acf-city-selector' ), 'https://acfcs.berryplasman.com/?utm_source=wpadmin&utm_medium=about_plugin&utm_campaign=acf-plugin' ); ?></p>
    ...
    <p><?php echo sprintf( __( 'If you need a Wordpress designer/coder for a project, contact me on me %s.', 'acf-city-selector' ), '<a href="https://berryplasman.com/contact/?utm_source=wpadmin&utm_medium=about_plugin&utm_campaign=acf-plugin">berryplasman.com</a>' ); ?></p>
