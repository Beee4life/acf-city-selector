                                ...
                                <ul class="acfcs__checkboxes">
                                    <?php foreach( $countries as $country_code => $country_name ) { ?>
                                        <li>
                                            ...
                                            <input type="checkbox" name="acfcs_delete_country[]" id="delete_<?php echo esc_attr( strtolower( $country_code ) ); ?>" value="<?php echo esc_attr( strtolower( $country_code ) ); ?>" /> <?php echo esc_html( $country_name ); ?>
                                        </li>
                                    <?php } ?>
                                </ul>
